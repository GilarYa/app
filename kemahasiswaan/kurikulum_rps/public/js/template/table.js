// export let rowtabel = `<tr class="h-18 border-b border-coolGray-100">
...
// #jbt#
// <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-green-500 text-left">#gaji#</th>
...
// export let jbt = `<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-center">#jabatan#</th>`
export let rowtabel = ` <tr class="h-18 border-b border-coolGray-100">
<th class="whitespace-nowrap px-4 bg-white text-left">
  <div class="flex items-center -m-2">
    <div class="w-auto p-2">
...
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-left">#Location#</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">#Orders#</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-green-500 text-left">#Totalspent#</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">#Sks#</th>
<th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800">
...
export let jbt = `<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-center">#Lastorders#</th>`